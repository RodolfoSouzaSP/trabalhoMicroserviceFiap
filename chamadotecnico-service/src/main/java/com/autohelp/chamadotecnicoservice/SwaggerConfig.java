...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		docket
		.select()
		.apis(RequestHandlerSelectors.basePackage("com.autohelp.chamadotecnicoservice"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("Chamado Técnico Service");
		apiInfoBuilder.description("Métodos para o microserviço de chamados técnicos.");
